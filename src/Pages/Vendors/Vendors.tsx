      ...
      <div className={styles.vendorsGrid}>
        {vendors?.map((vendor) => (
          <VendorCard 
            ...
            imageUrl='https://images.unsplash.com/photo-1445116572660-236099ec97a0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
          />
        ))}
      </div>
    </div>
